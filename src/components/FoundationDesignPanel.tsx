...
export default function FoundationDesignPanel({
  ...
  const [activeTab, setActiveTab ] = useState<'interactive' | 'reinforced-design' | 'reinforced-detailing' | 'autosize' | 'batch' | 'validation' | 'strip-footing' | 'classification' | 'settlement'>('interactive');
