                  ...
                  return (
                    <g key={`fplot-${idx}`}>
                      ...
                      <rect
                        ...
                        width={footW}
                        height={footH}
                        fill={isSelected ? 'rgba(59, 130, 246, 0.25)' : (overlappingColumnIds.has(loc.colId) ? 'rgba(239, 68, 68, 0.15)' : 'rgba(15, 23, 42, 0.8)')}
                        stroke={isSelected ? '#3b82f6' : (overlappingColumnIds.has(loc.colId) ? '#ef4444' : '#94a3b8')}
                        strokeWidth={isSelected ? 2.0 : (overlappingColumnIds.has(loc.colId) ? 1.6 : 1.1)}
                        className={`cursor-pointer transition-all hover:stroke-rose-400 ${overlappingColumnIds.has(loc.colId) ? 'animate-pulse' : ''}`}
                      ...
                      <rect 
                        ...
                        width="26" 
                        height="11" 
                        fill={overlappingColumnIds.has(loc.colId) ? '#991b1b' : '#020617'} 
                        rx="1.5" 
                        stroke={overlappingColumnIds.has(loc.colId) ? '#ef4444' : '#475569'} 
                        strokeWidth="0.6" 
                      />
                      <text
                        x={mapX(loc.x)}
                        y={fY - 4}
                        fill={overlappingColumnIds.has(loc.colId) ? '#fecaca' : '#38bdf8'}
                        textAnchor="middle"
